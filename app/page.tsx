    ...
    return (
        <main className="lg:flex h-fit">
            <section className="lg:sticky top-0 left-0 p-16 pt-24 lg:p-10 lg:w-2/5 lg:h-screen bg-blue flex flex-col items-center justify-center">
                <Avatar />
                <h1 className={`text-5xl font-bold text-center ${great_vibes.className}`}>Nghia Ngo</h1>
                ...
                <Link href={'https://www.cakeresume.com/nghia-trong-ngo'} target='_blank' className='btn btn-sm btn-outline btn-primary'>
                    <ExternalLinkIcon/>
                    <span>My CV</span>
                </Link>
            </section>
